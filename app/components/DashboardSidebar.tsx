        ...
        <div>
          ...
          <div
            ...
            className={`p-5 border-b border-lpink/20 flex items-center justify-between md:justify-start transition-all ${
              ...
              isDesktop
                ? 'cursor-pointer hover:bg-lpink/10 active:scale-98'
                : ''
            }`}
          >
            <div className="flex items-center gap-3">
              ...
              {(isExpanded || isMobileOpen) && (
                <div className="overflow-hidden whitespace-nowrap transition-all duration-300">
                  <h2 className="text-xs font-black font-fred uppercase text-bsblack tracking-wide">
                    Cornelia
                  </h2>
                  <p className="text-[9px] font-bold uppercase text-dpink tracking-widest">
                    Admin Panel
                  </p>
                </div>
              )}
                ...
                >
                  <span
                    className={
                      isActive
                        ? 'text-dpink'
                        : 'text-bsblack/40 group-hover:text-dpink transition-colors'
                    }
                  >
                    {item.icon}
                  </span>
